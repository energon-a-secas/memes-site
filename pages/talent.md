...
<section class="container mx-auto px-4 py-8">
  <div class="mb-8 text-center">
    <h2 class="text-3xl font-bold text-white mb-3">Talent Memes</h2>
    <p class="text-[#cacaca] text-lg">Self-deprecating work humor for the modern workplace</p>
  </div>
...
<style>
  .meme-card {
    ...
    border: 2px solid rgba(0, 99, 229, 0.3);
    background: #0a1628;
    cursor: pointer;
    transition: all 0.3s;
  }
