...
layout: custom
title: Mood
description: Images and GIFs for every mood
---

<section class="container mx-auto px-4 py-8">
  <div class="mb-8 text-center">
    <h2 class="text-3xl font-bold text-white mb-3">Mood</h2>
    <p class="text-[#cacaca] text-lg">Images and GIFs for every mood</p>
  </div>

  <div class="max-w-xl mx-auto mb-8">
    <div class="relative">
      <input type="text" id="category-search" placeholder="Search mood memes..."
  ...
  <div id="meme-gallery" class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-4">
    {% for image in site.static_files %}
      {% if image.path contains '/assets/images/mood/' %}
