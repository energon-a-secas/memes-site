...
layout: custom
title: Anime Memes
description: Anime references for the cultured developer
---

<section class="container mx-auto px-4 py-8">
  <div class="mb-8 text-center">
    <h2 class="text-3xl font-bold text-white mb-3">Anime Memes</h2>
    <p class="text-[#cacaca] text-lg">Anime references for the cultured developer</p>
  </div>

  <div class="max-w-xl mx-auto mb-8">
    <div class="relative">
      <input type="text" id="category-search" placeholder="Search anime memes..."
