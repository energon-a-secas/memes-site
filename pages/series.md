...
<section class="container mx-auto px-4 py-8">
  <div class="mb-8 text-center">
    <h2 class="text-3xl font-bold text-gray-800 mb-3">TV Series Memes</h2>
    <p class="text-gray-600 text-lg">TV series references for dedicated binge-watchers</p>
  </div>
  ...
  <div class="max-w-xl mx-auto mb-8">
    <div class="relative">
      <input
        type="text"
        id="category-search"
        placeholder="Search series memes..."
